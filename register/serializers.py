...
class RegistrationSerializer(serializers.ModelSerializer):
    ...
    phoneNumber = serializers.CharField(
        required=True,
        error_messages={
            "required": "Hello, Kindly provide us with a working Phone Number that we can contact you on",
        }
    )
    ...
    email = serializers.EmailField(
        required=True,
        error_messages={
            "required": "Hello, Kindly provide us with a working Email that we can contact you on",
        }
    )
    ...
    nextOfKin1Title = serializers.CharField(
        required=True,
        error_messages={
            "required": "Hello, How are you related",
        }
    )
    ...
    nextOfKin1Name = serializers.CharField(
        required=True,
        error_messages={
            "required": "Hello, Kindly provide us with the Name of your Next of kin",
        }
    )
    ...
    nextOfKin1Number = serializers.CharField(
        required=True,
        error_messages={
            "required": "Hello, Kindly provide us with the Phone number of your next of kin",
        }
    )
    ...
    tribe = serializers.CharField(
        required=True,
        error_messages={
            "required": "Hello, Kindly let us know your Tribe",
        }
    )
