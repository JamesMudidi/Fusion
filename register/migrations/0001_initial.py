    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sponsored', models.CharField(choices=[('CI', 'COMPASSION INTERNATIONAL'), ('K', 'KYAMPISI'), ('S', 'SELF')], max_length=2)),
                ...
                ('createdBy', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='account.User', to_field='username')),
            ],
        ),
        migrations.CreateModel(
